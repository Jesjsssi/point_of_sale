    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    <h4 class="mb-3">Daftar Order Belum Lunas</h4>
                </div>
                <div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <input type="text" id="search" class="form-control" name="search" placeholder="Cari order" value="{{ request('search') }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center list-action">
                                    ...
                                    <button type="button" class="btn btn-primary-dark mr-2" data-toggle="modal" data-target=".bd-example-modal-lg" id="{{ $order->id }}" onclick="payDue(this.id)">Bayar belum lunas</button>
                                </div>
                            </td>
                        </tr>
                        @endforeach
        ...
        <div class="modal-content">
            <form action="{{ route('order.updateDue') }}" method="post">
                ...
                <div class="modal-body">
                    <h3 class="modal-title text-center mx-auto">Bayar Belum Lunas</h3>
                    <div class="col-md-12">
