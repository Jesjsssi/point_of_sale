            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Riwayat Bayar Gaji</h4>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class=" row align-items-center">
                        ...
                        <div class="form-group col-md-6">
                            <label>Gaji yang dibayarkan</label>
                            <input class="form-control bg-white" value="{{ $paySalary->advance_salary ? $paySalary->advance_salary : 'No Gaji yang dibayarkan' }}" readonly>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Gaji yang belum dibayarkan</label>
