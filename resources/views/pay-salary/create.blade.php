                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="id" value="{{ $advanceSalary->id }}">
                        ...
                        <div class=" row align-items-center">
                            ...
                            <div class="form-group col-md-6">
                                <label for="advance_salary">Gaji yang dibayarkan <span class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('advance_salary') is-invalid @enderror" id="advance_salary" name="advance_salary" value="{{ $advanceSalary->advance_salary ? $advanceSalary->advance_salary : 'No Gaji yang dibayarkan' }}" readonly>
                            ...
                            <div class="form-group col-md-6">
                                <label for="due_salary">Gaji yang belum dibayarkan <span class="text-danger">*</span></label>
